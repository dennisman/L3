CodeMirror.defineMode("leekscript", function(config, parserConfig) {
  ...
  var keywords = function() {
    ...
    var jsKeywords = {
      ...
      "return": C, "break": C, "continue": C, "and": kw('and'), "or": kw('or'), "xor": kw('xor'), "not": kw('not'),
    ...
    for (var c in __LS_CONSTANTS) {
      jsKeywords[__LS_CONSTANTS[c]] = {type: "variable", style: "lsconst"};
    }
    for (var f in __LS_FUNCTIONS) {
      jsKeywords[__LS_FUNCTIONS[f]] = {type: "variable", style: "lsfunc"};
    }
