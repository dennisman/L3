...
string Move::getMove() {
    if (myType == DROP)
		return getHumanLocation(myEndPos);
	else if (myType == DROP_AND_CAPTURE)
		return getHumanLocation(myEndPos) + "," + getHumanLocation(myCapPos);
	else if (myType == MOVE)
		return getHumanLocation(myStartPos) + "-" + getHumanLocation(myEndPos);
	else
		return getHumanLocation(myStartPos) + "-" + getHumanLocation(myEndPos) + "," + getHumanLocation(myCapPos);
}
void Move::init() {
	ourMovesGenerated++;
}